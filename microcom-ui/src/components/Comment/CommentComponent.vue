<template>
  <a-list v-if="comments.length" :data-source="comments"
    ...
    <template #renderItem="{ item }">
      <a-list-item>
        <a-comment style="margin-left:30px" :author="item.createBy" :avatar="item.head" :content="item.content"
...
import { getComments,addComment} from '@/js/api/comment'
